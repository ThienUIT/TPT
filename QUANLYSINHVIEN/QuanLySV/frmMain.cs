...
namespace QLSV_GiaoDien
{
    ...
    public partial class frmMain : Form
    {
        ...
        private void tiếngViệtToolStripMenuItem_CheckedChanged(object sender, EventArgs e)
        {
            if (tiếngViệtToolStripMenuItem.Checked)
            {
                this.lang.SetLanguage((int)eLanguage.TiengViet);
                this.lang.ChangeLanguage(this.Name, this);
                this.tiếngViệtToolStripMenuItem.Checked = false;
            }
        }
